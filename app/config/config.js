module.exports = {
  ...
  signIn: 'SIGN IN',
  forgotPasswordSrnText1: 'Forgot your password ?',
  forgotPasswordSrnText2: 'We just need your registered Mobile number to sent',
  forgotPasswordSrnText3: 'you password reset instructions.',
  forgotButtonText: 'SEND',
  headerText: 'Omni Tracking',
  otpScrnText1: 'Sit back & Relax! while we verify your',
  otpScrnText2: 'mobile number',
  otpScrnText3: 'Enter the OTP below in case if we fail to detect the',
  otpScrnText4: 'SMS automatically',
  otpInput: 'Enter OTP',
  otpSubmitText: 'SUBMIT',
  otpResendText: 'RESEND',
  otpValidationText: 'Please enter OTP',
  newPassword: 'New password',
  confirmPassword: 'Confirm passwor',
  setPassBtnText: 'SUBMIT',
  setPassText1: 'Reset your password',
  setPassText2: 'Enter a new password for your account',
  setPassValidForNew: 'Please enter new password',
  setPassValidForConfirm: 'Please enter confirm password',
  setPassValidNotMatch: 'New password and confirm password do not match',
  tabText1: 'Scan',
  tabText2: 'Checklist',
  tabText3: 'Schedules',
  successAlertText: 'Thank you!',
  logoutTitle: 'Logout',
  logoutText: 'Are you sure you want to logout?',
  logoutOkBtn: 'Ok',
  logoutCancelBtn: 'Cancel',
  checklistViewMsg: "Please Check-in to view today's Checklist",
  androidLocationTitle: 'EVV would like to use Your Location.',
  androidLocationText: 'EVV use location for tracking, Please enable it from settings.',
  androidLocationOkBtn: 'Open Settings',
  androidLocationCancelBtn: 'Cancel',
  incompleteVisitText: ' Visits require your attention',
  scheduleInfo: 'Schedule Information',
  nextAppInfo: 'Appointment Info',
  changePassMenu: 'Change Password',
  settingMenu: 'Settings',
  helpMenu: 'Help',
  termsAndConMenu: 'Terms and Condition',
  logoutMenu: 'Logout',
  checkListSubmitBtn: 'Submit',
  etcActivity: 'Extra Activity',
  injuryToClinet: 'Any injuries to Client or to yourself?',
  milage: 'Do you have any reimbursement mileage to enter?',
  callOffice: 'Call office immediately',
  leaveTime: 'What time did you leave?',
  enterMilage: 'Enter reimbursement mileage',
  milageBtn: 'DONE',
  changePassText1: 'Change your password',
  changePassText2: 'Enter a new password for your account.',
  changeCurrentPass: 'Current password',
  changeNewPass: 'New password',
  changeConfirmPass: 'Confirm password',
  changePassSubBtn: 'CHANGE PASSWORD',
  changePassValidForCurrent: 'Please enter current password',
  changePassValidForNew: 'Please enter new password',
  changePassValidForConfirm: 'Please enter confirm password',
  changePassValidNotMatch: 'New password and confirm password do not match',
  signature: 'Signature',
  signatureResetBtn: 'RESET',
  signatureSaveBtn: 'SAVE',
  clientSingnature: 'Client’s Signature',
  settingsTitle: 'Settings',
  settingCameraPer: 'Camera',
  settingLocationPer: 'Location'
};